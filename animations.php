...
<nav class="navbar-navbar-inverse">
    <div class="container-fluid">
        ...
        <div class="Text text-center" id="shimmer">
            <br>
        ...
        <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 text-left">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6">
                    ...
                    <div class="row">
                        <div id="image1" class="images">
                            <a href="./img/MissouriMoon.jpg" target="new">
                                <img src="./img/MissouriMoon.jpg" target="_self"
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <br><br>
                    <div class="row2">
                        <div id="image7" class="images">
                            <a href="./img/color.jpg" target="new">
