                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div id="passDiv" class="form-group">
                            ...
                            <input type="password" id="password" class="form-control" required="true"
                                   placeholder="Password" onblur="passwordFormat(this);"/>
                        ...
                        <div id="verPassDiv" class="form-group">
                            ...
                            <input type="password" id="verification" class="form-control" required="true"
                                   placeholder="Verify Password" onblur="passwordMatch(this);"/>
                        ...
                        <div class="form-group" id="FirstDiv">
                            ...
                            <input id="firstname" name="firstname" class="form-control"
                                   type="text" placeholder="First" required="true" onblur="checkFirst(this);">
                        ...
                        <div class="form-group" id="LastDiv">
                            ...
                            <span id="LastErr" class="help-block hide">Input Last Name (<50 Characters)</span>
                        </div>
                        ...
                        <div class="form-group" id="Add2Div">
                            ...
                            <input id="address2" name="address2" class="form-control"
                                   type="text" placeholder="Address Line 2 (Optional)" onblur="checkAddress2(this);">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        ...
                        <div class="form-group" id="ZipDiv">
                            ...
                            <input id="zip" name="zip" class="form-control" onblur="checkZip(this);"
                                   type="text" placeholder="Zip Code" required="true" minlength="5"
                                   maxlength="10"/>
                        ...
                        <div class="form-group" id="PhoneDiv">
                            ...
                            <input id="phonenumber" name="phonenumber" class="form-control"
                                   type="text" maxlength="12" placeholder="###-###-####"
                                   required="true"/>
                        </div>
                        ...
                        <div class="form-group" id="EmailDiv">
                            ...
                            <input id="email" type="email" class="form-control"
                                   ...
                                   onblur="checkEmail(this);" maxlength="50"/>
